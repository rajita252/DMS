...
public class CurrentItems extends Activity {
    ...
    void fetchDataFromDataBase() {
        ...
        Cursor c = db.rawQuery("SELECT * FROM record1", null);
    ...
    private void itemReceived() {
        ...
        String query = "INSERT INTO received1 values('" + title1 + "','" + category1 + "','"+ condition1 + "','"+ mob1 + "','"+ address1 +"')";
    ...
    {
        db.execSQL("DELETE FROM record1 where title = '"+titleToDelete+"'");
    ...
    {
        db.execSQL("CREATE TABLE IF NOT EXISTS received1 (id INTEGER PRIMARY KEY AUTOINCREMENT,title varchar, category varchar, condition varchar, mob varchar, address varchar)");
